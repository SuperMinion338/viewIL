  ...
  return (
    <div className="flex min-h-screen bg-gray-50" dir="rtl">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <MobileTopBar />
        <header className="hidden md:block bg-white border-b border-gray-100 px-6 py-4 sticky top-0 z-10 shadow-sm">
          <h1 className="text-lg font-bold text-gray-800">הפרופיל שלי</h1>
          <p className="text-xs text-gray-400">ניהול חשבון והגדרות</p>
        </header>

        <main className="flex-1 p-4 md:p-6 max-w-3xl w-full flex flex-col gap-6 pb-24 md:pb-6">
          {loadingProfile ? (
              ...
              <section className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col gap-5">
                ...
                <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-5 text-white relative overflow-hidden">
                  ...
                  <p className="text-white/90 text-sm leading-relaxed mb-4">
                    ViewIL בחינם לגמרי עד {MAX_USERS.toLocaleString("he-IL")} המשתמשים הראשונים. אתה אחד מהם!
                  </p>
                  ...
                  <div className="bg-white/10 rounded-xl p-3">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs font-bold text-white">
                        {userCount !== null ? userCount.toLocaleString("he-IL") : "..."} / {MAX_USERS.toLocaleString("he-IL")} משתמשים
                      </span>
                    </div>
      ...
      <MobileBottomNav activeTool="profile" />
    </div>
  );
}
